...
Give the application the name of **my-app** and run the commands below to complete the setup and get the app running locally on the development server [http://localhost:3000](http://localhost:3000).
