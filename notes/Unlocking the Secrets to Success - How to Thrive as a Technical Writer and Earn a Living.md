...
When it comes to sharing articles with the client especially if it is in Markdown format I have been using [HackMD](https://hackmd.io) and [Dropbox Paper](https://www.dropbox.com/paper/start).
