...
Replace the code in the `App.js` and `App.css` files with the code below
...
You should see it working now in your browser window. There is an online working example of the app here [Youtube Content Selector App](https://youtube-content-selector.netlify.app/)
